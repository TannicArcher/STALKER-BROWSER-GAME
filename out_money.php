...
?>
<?php
$query = "update users set money=money+'$o_money' where id = '$user_id' limit 1";
$result = mysqli_query($dbc, $query) or die ('Ошибка передачи запроса к БД');
$query = "update clans set clan_money=clan_money-'$o_money' where clan_id = '$c_id' limit 1";
$result = mysqli_query($dbc, $query) or die ('Ошибка передачи запроса к БД');
?>
<?php
$query_add_log = "insert into clan_log (`time`, `clan_id`, `user_id`, `tip`, `why`, `num`) values ( NOW(), '$clan', '$id_u', '1', '2', '$o_money')";
