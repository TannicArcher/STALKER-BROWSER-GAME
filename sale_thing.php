...
<div id="main">
  <div class="stats">
    <p class="podmenu">Товар Сыча</p>
  </div>
  <div class="stats">
    <p><img src="img/ico/left.png" /> <a href="salesman.php">Назад к Сычу</a></p>
  </div>
  <?php 
  $user_id = $_SESSION['id'];
  ...
  <table width="190" border="0" cellpadding="0" cellspacing="0">
	  ...
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=1&money=1" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/materials.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price_hab'];?></span></a>] <br /><?php }  else {?><p class="clothes"><span class="bonus">[Mожно получить на <a href="monsters.php">рейде</a>  или приобрести на <a href="auction.php">аукционе</a>]</span></p>
	  <?php }
	  if ($row_cl['price'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=1&money=2" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/money.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price'];?></span></a>]<?php }
	  ?></p>
	  </div>
	  <?php
  }
  ...
  <table width="190" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <div class="zx"><?php if ($row_cl['price_hab'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=4&money=1" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/materials.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price_hab'];?></span></a>] <br /><?php }  else {?><p class="clothes"><span class="bonus">[Купить шлем можно только за RUB]</span></p>
	  <?php }
	  if ($row_cl['price'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=4&money=2" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/money.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price'];?></span></a>]<?php }
	  ?></p>
	  </div>
	  <?php
  }
  ...
  <table width="190" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <div class="zx"><?php if ($row_cl['price_hab'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=2&money=1" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/materials.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price_hab'];?></span></a>] <br /><?php }    else {?><p class="clothes"><span class="bonus">[Mожно получить на <a href="monsters.php">рейде</a>  или приобрести на <a href="auction.php">аукционе</a>]</span></p>
	  <?php }
	  if ($row_cl['price'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=2&money=2" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/money.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price'];?></span></a>]<?php }
	  ?></p>
	  </div>
	  <?php
  }
  ...
  <img src="img/weapons/<?php echo $row_cl['screen'];?>" alt="Слот №1" />
    ...
    <div class="zx"><?php if ($row_cl['price_hab'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=3&money=1" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/materials.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price_hab'];?></span></a>] <br /><?php }    else {?><p class="clothes"><span class="bonus">[Mожно получить на <a href="monsters.php">рейде</a>  или приобрести на <a href="auction.php">аукционе</a>]</span></p>
    <?php }
	  if ($row_cl['price'] >=0) {
	  ?>[<a href="buy_thing.php?thing=<?php echo "$thing_id";?>&type=3&money=2" onclick="return confirm ('Уверены?')">Купить за <img src="img/ico/money.png" width="12" height="12"/> <span class="white"><?php echo $row_cl['price'];?></span></a>]<?php }
	  ?></p>
    </div>
	  <?php
  }
...
<div class="stats">
<p class="bonus" style="font-size:13px;">Вся статистика представлена в виде (max-min) и может выпасть только в этом интервале.</p>
</div>
</div>
<?php
