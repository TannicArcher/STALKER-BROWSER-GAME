...
if (empty($location)) {
  ...
  if ($location <> 'voensklad1' and $location <> 'voensklad2' and $location <> 'voensklad3' and $location <> 'voensklad4' and $location <> 'voensklad5' and $location <> 'voensklad6' and $location <> 'voensklad7') {
   ?>
    <script type="text/javascript">
    document.location.href = "zona.php";
    </script>
  ...
  if ($us_location <> 'voensklad1' and $us_location <> 'voensklad2' and $us_location <> 'voensklad3' and $us_location <> 'voensklad4' and $us_location <> 'voensklad5' and $us_location <> 'voensklad6' and $us_location <> 'voensklad7' and $us_location <> 'index') {
    ?>
    <script type="text/javascript">
    document.location.href = "zona.php";
    </script>
...
//////////////////////////////////////////////////////////////////////TELEPORT
if ($location == 'voensklad1') {
  if ($us_gruppa <> 'naemniki' and $us_location <> 'voensklad3') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'naemniki' and $us_location <> 'voensklad3' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'voensklad2') {
  if ($us_gruppa <> 'svoboda' and $us_location <> 'voensklad4') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'svoboda' and $us_location <> 'voensklad4' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'voensklad7') {
  if ($us_gruppa <> 'dolg' and $us_location <> 'voensklad6') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'dolg' and $us_location <> 'voensklad6' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
///////
if ($location == 'voensklad6') {
  if ($us_location <> 'voensklad7' and $us_location <> 'voensklad3' and $us_location <> 'voensklad4' and $us_location <> 'voensklad5') {
    $location = "$us_location";
  }
}
if ($location == 'voensklad3') {
  if ($us_location <> 'voensklad5' and $us_location <> 'voensklad6' and $us_location <> 'voensklad4' and $us_location <> 'voensklad1') {
    $location = "$us_location";
  }
}
if ($location == 'voensklad5') {
  if ($us_location <> 'voensklad3' and $us_location <> 'voensklad6' and $us_location <> 'voensklad4') {
    $location = "$us_location";
  }
}
if ($location == 'voensklad4') {
  if ($us_location <> 'voensklad2' and $us_location <> 'voensklad6' and $us_location <> 'voensklad3' and $us_location <> 'voensklad5' and $us_location <> 'index') {
    $location = "$us_location";
  }
}

if ($location <> 'voensklad7' and $location <> 'voensklad1' and $location <> 'voensklad2' and $location <> 'voensklad3' and $location <> 'voensklad4' and $location <> 'voensklad5' and $location <> 'voensklad6') {
?>
    <script type="text/javascript">
    document.location.href = "zona.php";
    </script>
...
if ($row_loc['bp_gruppa'] <> $us_gruppa) {
  if ($us_gruppa == 'naemniki') {
    if ($location == 'voensklad3' and $us_location == 'voensklad1') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad4' and $us_location == 'voensklad3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad5' and $us_location == 'voensklad3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad2' and $us_location == 'voensklad4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad4' and $us_location == 'voensklad5') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad5' and $us_location == 'voensklad6') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad6' and $us_location == 'voensklad3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad7' and $us_location == 'voensklad6') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad6' and $us_location == 'voensklad4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad4' and $us_location == 'voensklad6') {
	  $location = "$us_location";
      $err = 7;
	}
  }
  if ($us_gruppa == 'dolg') {
	...
	if ($location == 'voensklad3' and $us_location == 'voensklad6') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad5' and $us_location == 'voensklad6') {
	...
	if ($location == 'voensklad3' and $us_location == 'voensklad5') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad3' and $us_location == 'voensklad4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad4' and $us_location == 'voensklad3') {
	...
	if ($location == 'voensklad1' and $us_location == 'voensklad3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad2' and $us_location == 'voensklad4') {
  ...
  if ($us_gruppa == 'svoboda') {/////////////////////////////////////////////////////
    if ($location == 'voensklad4' and $us_location == 'voensklad2') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad6' and $us_location == 'voensklad4') {
	...
	if ($location == 'voensklad5' and $us_location == 'voensklad4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad6' and $us_location == 'voensklad5') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'voensklad3' and $us_location == 'voensklad5') {
...
////////////////////////////////////////////Названия локаций
if ($location == 'voensklad1') { $page_title = 'Лифт';}
if ($location == 'voensklad2') { $page_title = 'Вход в лабораторию';}
if ($location == 'voensklad3') { $page_title = 'Упавший лифт';}
if ($location == 'voensklad4') { $page_title = 'Комната с бюрерами';}
if ($location == 'voensklad5') { $page_title = 'Комната с теслой';}
if ($location == 'voensklad6') { $page_title = 'Комната снорков';}
if ($location == 'voensklad7') { $page_title = 'Комната тушканов';}
/////////////////////////////////////////////////
...
$lok_out=1;
  ...
  if ($row_loc['lvl_need'] > $us_lvl) {
    ?>
    <script type="text/javascript">
    document.location.href = "zona.php?err=5";
    </script>
    <?php
    exit();
  }
...
if ($location == 'voensklad1') {
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad3' limit 1";
...
<p><img src="img/ico/bottomright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad3">Бежать к упавшему лифту</a></p>
<?php
}
////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
if ($location == 'voensklad2') {
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad4' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottomleft.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad4">Бежать к бюрерам</a></p>
<?php
}
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
if ($location == 'voensklad3') {
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad1' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/topleft.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad1">Бежать к лифту</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad4' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
...
<p><img src="img/ico/right.png" width="12" height="12"/> <?php
  ...
  ?>  <a href="voensklad.php?location=voensklad4">Бежать к бюрерам</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad5' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottomright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad5">Бежать к тесле</a></p>
  <?php
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad6' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottom.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad6">Бежать к сноркам</a></p>
<?php
}
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
...
if ($location == 'voensklad4') {
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad2' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/topright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad2">Бежать к основному входу</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad3' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
...
<p><img src="img/ico/topright.png" width="12" height="12"/> <?php
  ...
  ?>  <a href="voensklad.php?location=voensklad4">Бежать к бюрерам</a></p>
  <?php
$query_loc = "Select bp_gruppa from location where location_name = 'voensklad7' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottom.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="voensklad.php?location=voensklad7">Бежать к тушканам</a></p>
<?php
...
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
if ($us_gruppa == 'naemniki' and $location == 'voensklad1') {
...
if ($us_gruppa == 'dolg' and $location == 'voensklad7') {
...
if ($us_gruppa == 'svoboda' and $location == 'voensklad2') {
...
if ($us_gruppa == 'mon' and $location == 'voensklad4') {
