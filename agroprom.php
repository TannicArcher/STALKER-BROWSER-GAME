...
if (empty($location)) {
  ...
  if ($location <> 'agroprom1' and $location <> 'agroprom2' and $location <> 'agroprom3' and $location <> 'agroprom4' and $location <> 'agroprom5' and $location <> 'agroprom6') {
   ?>
    <script type="text/javascript">
    document.location.href = "zona.php";
    </script>
  ...
  if ($us_location <> 'agroprom1' and $us_location <> 'agroprom2' and $us_location <> 'agroprom3' and $us_location <> 'agroprom4' and $us_location <> 'agroprom5' and $us_location <> 'agroprom6' and $us_location <> 'index') {
    ?>
    <script type="text/javascript">
    document.location.href = "zona.php";
    </script>
...
//////////////////////////////////////////////////////////////////////TELEPORT
if ($location == 'agroprom1') {
  if ($us_gruppa <> 'naemniki' and $us_location <> 'agroprom3') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'naemniki' and $us_location <> 'agroprom3' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'agroprom2') {
  if ($us_gruppa <> 'svoboda' and $us_location <> 'agroprom4') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'svoboda' and $us_location <> 'agroprom4' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'agroprom6') {
  if ($us_gruppa <> 'dolg' and $us_location <> 'agroprom5') {
    $location = "$us_location";
  }
  if ($us_gruppa == 'dolg' and $us_location <> 'agroprom5' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'agroprom5') {
  if ($us_location <> 'agroprom6' and $us_location <> 'agroprom3' and $us_location <> 'agroprom4' and $us_location <> 'index') {
    $location = "$us_location";
  }
}
if ($location == 'agroprom3') {
  if ($us_location <> 'agroprom5' and $us_location <> 'agroprom4' and $us_location <> 'agroprom1') {
    $location = "$us_location";
  }
}
if ($location == 'agroprom4') {
  if ($us_location <> 'agroprom2' and $us_location <> 'agroprom3' and $us_location <> 'agroprom5') {
    $location = "$us_location";
  }
}
...
//////////////////////////////////////////////////////////////////////
$query_loc = "select bp_gruppa from location where location_name = '$us_location'";
...
if ($row_loc['bp_gruppa'] <> $us_gruppa) {
  if ($us_gruppa == 'naemniki') {
    if ($location == 'agroprom3' and $us_location == 'agroprom1') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom4' and $us_location == 'agroprom3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom5' and $us_location == 'agroprom3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom2' and $us_location == 'agroprom4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom5' and $us_location == 'agroprom4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom4' and $us_location == 'agroprom5') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom6' and $us_location == 'agroprom5') {
	  $location = "$us_location";
      $err = 7;
	}
  }
  if ($us_gruppa == 'dolg') {
        if ($location == 'agroprom5' and $us_location == 'agroprom6') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom3' and $us_location == 'agroprom5') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom4' and $us_location == 'agroprom5') {
	...
	if ($location == 'agroprom3' and $us_location == 'agroprom4') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom4' and $us_location == 'agroprom3') {
	...
	if ($location == 'agroprom1' and $us_location == 'agroprom3') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom2' and $us_location == 'agroprom3') {
	  $location = "$us_location";
      $err = 7;
	}
  }
  if ($us_gruppa == 'svoboda') {/////////////////////////////////////////////////////
    if ($location == 'agroprom4' and $us_location == 'agroprom2') {
	  $location = "$us_location";
      $err = 7;
	}
	if ($location == 'agroprom3' and $us_location == 'agroprom4') {
...
if ($location == 'index') {
  ...
  $query_loc = "update users set location = '$location' where id = '$user_id'";
  $result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД3');

////////////////////////////////////////////Названия локаций
if ($location == 'agroprom1') { $page_title = 'Оазис, вход';}
if ($location == 'agroprom2') { $page_title = 'Оазис, комната зомбированных';}
if ($location == 'agroprom3') { $page_title = 'Оазис, комната тушканов';}
if ($location == 'agroprom4') { $page_title = 'Оазис, путепроводные трубы ';}
if ($location == 'agroprom5') { $page_title = 'Оазис, телепорт';}
if ($location == 'agroprom6') { $page_title = 'Оазис, древо жизни';}
/////////////////////////////////////////////////
...
$query_loc = "select count, lvl_need, lvl_to , count_now, bp_gruppa, bp_count, bp_count_now, bp_count_grouppa from location where location_name = '$location'";
  $result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД4');
  $row_loc = mysqli_fetch_array($result_loc);
  ?>
<div id="main">
...
$lok_out=1;
  ...
  if ($row_loc['lvl_need'] > $us_lvl) {
    ?>
    <script type="text/javascript">
    document.location.href = "zona.php?err=3";
    </script>
    <?php
    exit();
  }
...
if ($location == 'agroprom1') {
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom3' limit 1";
...
<p><img src="img/ico/bottomright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom3">Бежать к тушканам</a></p>
<?php
}
////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
if ($location == 'agroprom2') {
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom4' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottomleft.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom4">Подбежать к трубам</a></p>
<?php
}
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
if ($location == 'agroprom3') {
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom1' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/topleft.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom1">Бежать к выходу</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom4' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
...
<p><img src="img/ico/right.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom4">Бежать к трубам</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom5' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottomright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom5">Бежать к телепорту</a></p>
<?php
}
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
...
if ($location == 'agroprom4') {
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom2' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/topright.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom2">Бежать к зомбированным</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom3' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
...
<p><img src="img/ico/topright.png" width="12" height="12"/> <?php
  ...
  ?>  <a href="agroprom.php?location=agroprom4">Бежать к трубам</a></p>
<?php
$query_loc = "Select bp_gruppa from location where location_name = 'agroprom6' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД');
$row_loc = mysqli_fetch_array($result_loc);
?>
<p><img src="img/ico/bottom.png" width="12" height="12"/> <?php
  ...
  if ($row_loc['bp_gruppa'] == 'naemniki') {?><img src="img/ico/odinochkion.png" width="12" height="12" alt="o"/><?php }
  if ($row_loc['bp_gruppa'] == 'mon') {?><img src="img/ico/monolit.png" width="12" height="12" alt="o"/><?php }
  ?>  <a href="agroprom.php?location=agroprom6">Бежать к древу жизни</a></p>
<?php
}
///////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
...
if ($us_gruppa == 'naemniki' and $location == 'agroprom1') {
...
if ($us_gruppa == 'dolg' and $location == 'agroprom6') {
...
if ($us_gruppa == 'svoboda' and $location == 'agroprom2') {
...
if ($us_gruppa == 'mon' and $location == 'agroprom5') {
