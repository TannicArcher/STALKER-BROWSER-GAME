...
<?php
if ($tip == '') {?>
<center><p class="white">Поиск переписки:</p></center>
<a class="menu1" href="mail2.php?tip=1">По нику</a>
<a class="menu1"  href="mail2.php?tip=2">По id</a>
<?php }
if ($tip == '1') {?>
<p class="white">Поиск по нику:</p>
<form enctype="multipart/form-data" method="post" action="tt.php?tip=1">
<input type="text" style="width:150px; height:18px;" class="input" name="nick" />
<input type="submit" style="width:50px;" class="input" value="искать" name="addchat"/>
</form>
<?php }
if ($tip == '2') {?>
<p class="white">Поиск по id:</p>
<form enctype="multipart/form-data" method="post" action="tt.php?tip=2">
<input type="text" style="width:150px; height:18px;" class="input" name="id" />
<input type="submit" style="width:50px;" class="input" value="искать" name="addchat"/>
</form>
<?php }
?>
...
<center><a class="menu" href="allread.php" style="color: green;">Отметить всё как прочитанное</a></center>
<p class="podmenu" style="border-top:1px solid #444e4f; background-color:#1c252f;"></p>
<?php
...
<a href="mail4.php?id=<?php echo "$id2";?>" style="text-decoration: none;">
