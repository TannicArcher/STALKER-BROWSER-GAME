...
$query_loc = "update users set location = 'secret' where id = '$user_id' limit 1";
$result_loc = mysqli_query($dbc, $query_loc) or die ('Ошибка передачи запроса к БД3');
////////////////////////////////////////////Названия локаций
$page_title = 'Перестрелки';
/////////////////////////////////////////////////
...
$query_loc = "select count, lvl_need, lvl_to , count_now, bp_gruppa, bp_count, bp_count_now, bp_count_grouppa from location where location_name = 'secret' limit 1";
...
?><p><img src="img/ico/povtor.png" width="12" height="12" alt="o"/> <a href="secret.php">Обновить</a></p>
<p><img src="img/ico/out.png" width="12" height="12" alt="o"/> <a href="index.php">Отступить</a></p><?php
}
if ($us_gruppa == 'dolg') {
?><p><img src="img/ico/povtor.png" width="12" height="12" alt="o"/> <a href="secret.php">Обновить</a></p>
<p><img src="img/ico/out.png" width="12" height="12" alt="o"/> <a href="index.php">Отступить</a></p><?php
