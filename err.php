...
?>
    <div id="main">
<?php
$query_num = "Select id from users where ban='1' " ;
...
if (!empty($_GET['page'])) {
  ...
  $cur_page = 1;
	...
	if ($num_page > 0) {
	  $query_us = "Select nick ,id,gruppa, last_active, lvl, slava, why_ban from users where ban='1' order by last_active DESC limit $skip, $result_per_page";
	...
	$slava = $row_us['slava'];
	  ...
	  <span class="white"><br/><?php echo $row_us['why_ban'];?></span>
	</div>
