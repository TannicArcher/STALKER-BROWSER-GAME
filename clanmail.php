...
$query = "update users set location = 'mail', clan_mes='0' where id = '$log_id' limit 1";
...
<p class="podmenu">Отрядные сообщения</p>
</div></center> 
...
<center>
  <p>Сообщение:</p><br/>
<form enctype="multipart/form-data" method="post" action="clan_mail.php" name="message">
<?php
require_once('inc_smiles_panel.php');
?>
<textarea rows="2" style="width:98%; height:60px;" cols="35px" name="msg" autofocus required></textarea>
<div class="knopka">
...
<center>
<a href="clanmail.php" class="menu2">
...
<p class="podmenu" style="border-top:1px dashed #444e4f;"></p>
	...
	<?php
	$query_num = "Select post_id from clan_mail where clan_id = '$clan_cc' " ;
...
if (!empty($_GET['page'])) {
  ...
  $cur_page = 1;
	...
	if ($num_page > 0) {
  $query_chat = "SELECT * FROM `clan_mail` where clan_id = '$clan_cc' ORDER BY `time` DESC limit $skip, $result_per_page";
  ...
  if (!empty($count_chat)) {
	...
	$query_ch = "Select clan, nick, clan_rang, last_active from users where id = '$id_chat'";
...
$razn = ($now - $time);
if ($razn_last_act < 1800 ) {?><img src="img/ico/on.png" width="12" height="12" alt="н"/><?php 
if ($clan_rang == '0' and $clann == $clan_cc) {?><img src="img/ico/no.png"/><?php }
if ($clan_rang == '1' and $clann == $clan_cc) {?><img src="img/rangs/rekryton.png"/><?php }
if ($clan_rang == '2' and $clann == $clan_cc) {?><img src="img/rangs/ryadovoyon.png"/><?php }
if ($clan_rang == '3' and $clann == $clan_cc) {?><img src="img/rangs/serjanton.png"/><?php }
if ($clan_rang == '4' and $clann == $clan_cc) {?><img src="img/rangs/leitenanton.png"/><?php }
if ($clan_rang == '5' and $clann == $clan_cc) {?><img src="img/rangs/kapitanon.png"/><?php }
if ($clan_rang == '6' and $clann == $clan_cc) {?><img src="img/rangs/mayoron.png"/><?php }
if ($clan_rang == '7' and $clann == $clan_cc) {?><img src="img/rangs/polkovnikon.png"/><?php }
if ($clan_rang == '8' and $clann == $clan_cc) {?><img src="img/rangs/generalon.png"/><?php }
if ($clan_rang == '9' and $clann == $clan_cc) {?><img src="img/rangs/zamon.jpg"/><?php }
if ($clan_rang == '10' and $clann == $clan_cc) {?><img src="img/rangs/lideron.png"/><?php }
if ($clann != $clan_cc) {?><img src="img/ico/no.png"/><?php }
?>
<?php } else {?><img src="img/ico/off.png" width="12" height="12" alt="н"/><?php 
if ($clan_rang == '0' and $clann == $clan_cc) {?><img src="img/ico/no.png"/><?php }
if ($clan_rang == '1' and $clann == $clan_cc) {?><img src="img/rangs/rekryton.png"/><?php }
if ($clan_rang == '2' and $clann == $clan_cc) {?><img src="img/rangs/ryadovoyon.png"/><?php }
if ($clan_rang == '3' and $clann == $clan_cc) {?><img src="img/rangs/serjanton.png"/><?php }
...
if ($time11 > '373248000') {?>более 5 лет<?php }
?>]<br /> 
<?php if ($clan_rang != '9') {?><span class="<?php
if ($clan_rang == '10' and $clann == $clan_cc) {?>gold<?php }
if ($clan_rang == '8' and $clann == $clan_cc) {?>bonus<?php }
if ($clan_rang != '9' and $clan_rang != '8' and $clan_rang != '10' and $clann == $clan_cc) {?>white<?php }
?>">
<?php } else {?>
