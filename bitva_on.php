...
$id_2 = $row_usg['id'];
$query_cl = "Select slava, war, clan_habar, clan_money, name, time_war from clans where clan_id = '$clan1'  limit 1";
...
$clan2 = $row_cl1['clan_id'];
$slava2 = $row_cl1['slava']; 
$clan2_w = $row_cl1['war'];
$name2 = $row_cl1['name'];
...
$now = strtotime("$now");
$time_war1q = ($time_war1 + '18000');
$time_war2q = ($time_war2 + '18000');
...
$slava1_2 = ($slava1 * '2');
?>
<?php if ($clan1_w == '1' or $clan2_w == '1' or $clan_rang < '8' or $clan1 == $clan2 or $time_q1 > '0' or $time_q2 > '0' or $h_clan1 < '50000' or $sostav1 < '5' or $sostav2 < '5' or $slava2 < $slava1_1 or $slava2 > $slava1_2) {?>
  <script type="text/javascript">
